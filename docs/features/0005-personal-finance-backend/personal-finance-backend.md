...
- [016 Analytics Report Endpoint And Shared Filter Contract](done/016-analytics-report-endpoint-and-shared-filter-contract.md) - Add richer report analytics payloads and define shared filter semantics between report and ledger endpoints.
- [017 Exact Report-Ledger Parity Via Shared Query Semantics](done/017-exact-report-ledger-parity-via-shared-query-semantics.md) - Define exact report-to-ledger parity behavior through equivalent query semantics.
